...
do
    ...
    wget https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/Linux_x64%2F843831%2Fchrome-linux.zip?alt=media -O /opt/chrome/stable/chrome-linux.zip
    #wget "https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/\
    #Linux_x64%2F${chrome_versions[$br]}%2Fchrome-linux.zip?alt=media" -O "/opt/chrome/stable/chrome-linux.zip"
    unzip "/opt/chrome/stable/chrome-linux.zip" -d "/opt/chrome/stable/"
